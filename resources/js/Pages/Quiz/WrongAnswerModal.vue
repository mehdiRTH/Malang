        ...
        <div class="bg-gray-800 p-4">
            ...
            <div class="flex items-center justify-center">
                ...
                <thead>
                    ...
                    </th><th class="border-b border-blue-gray-50 py-3 px-6 text-left">
                ...
                <tbody>
                    <tr v-for="answer in $page.props.auth.wrong_answers">
                        ...
                        <td class="py-3 px-5 border-b border-blue-gray-50">
                            <div class="flex items-center justify-center gap-4">
                            <p
                                :class="{'text-success':answer.answer.grammar.presens==answer.right_answer.grammar.presens,'text-danger':answer.answer.grammar.presens!=answer.right_answer.grammar.presens}"
                                class="block text-center antialiased font-sans text-sm leading-normal  font-bold">{{ answer.answer.grammar.presens==null ? 'None' : answer.answer.grammar.presens }}</p>
                            </div>
                        </td>
                        <td class="py-3 px-5 border-b border-blue-gray-50">
                            <div class="flex items-center justify-center gap-4">
                            <p class="block text-center antialiased font-sans text-sm leading-normal text-success font-bold">{{ answer.right_answer.grammar.presens }}</p>
                            </div>
                        </td>
                        <td class="py-3 px-5 border-b border-blue-gray-50">
                            <div class="flex items-center justify-center gap-4">
                            <p
                                :class="{'text-success':answer.answer.grammar.imperfectum==answer.right_answer.grammar.imperfectum,'text-danger':answer.answer.grammar.imperfectum!=answer.right_answer.grammar.imperfectum}"
                                class="block text-center antialiased font-sans text-sm leading-normal  font-bold">{{ answer.answer.grammar.imperfectum==null ? 'None' : answer.answer.grammar.imperfectum }}</p>
                            </div>
                        </td>
                        <td class="py-3 px-5 border-b border-blue-gray-50">
                            <div class="flex items-center justify-center gap-4">
                        ...
                        <td class="py-3 px-5 border-b border-blue-gray-50">
                            <div class="flex items-center justify-center gap-4">
                            <p
                                :class="{'text-success':answer.answer.grammar.perfectum==answer.right_answer.grammar.perfectum,'text-danger':answer.answer.grammar.perfectum!=answer.right_answer.grammar.perfectum}"
                                class="block text-center antialiased font-sans text-sm leading-normal  font-bold">{{ answer.answer.grammar.perfectum==null ? 'None' : answer.answer.grammar.perfectum }}</p>
                            </div>
                        </td>
                        <td class="py-3 px-5 border-b border-blue-gray-50">
                            <div class="flex items-center justify-center gap-4">
