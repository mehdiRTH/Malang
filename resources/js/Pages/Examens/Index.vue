...
<AuthenticatedLayout label="This Month Exams">
    ...
    <div class="container px-5 py-14 mx-auto">
        ...
        <Link v-for="exam in examens.data" :href="route('examen.custom_examen',{start_date:exam.startDate,end_date:exam.endDate})" class="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
